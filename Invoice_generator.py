...
def generate_invoice():
    ...
    doc.save(doc_name)
    messagebox.showinfo("Invoice Generated","Your invoice has been successfully generated")
    new_invoice()
...
new_onvoice_button=tkinter.Button(frame,text="New Invoice",command=new_invoice)
new_onvoice_button.grid(row=7,column=0,columnspan=3,sticky="news",padx=20,pady=5)
window.mainloop()